  ...
  <el-row class="warp">
    ...
    <el-col :span="24" class="warp-main">
      ...
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm ">
        <el-form-item label="公司编号" prop="name">
        ...
        <el-form-item label="公司地址" prop="region">
          <el-select v-model="ruleForm.region" placeholder="浙江省"  style="width:220px;">
...
<script>
  ...
  import {getQueryregion } from '../../api/api';

  export default {
    created(){
      getQueryregion(0).then((res) => {
